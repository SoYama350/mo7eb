...
export interface Package { id: string; providerId: string; name: string; internetGB?: number | null; minutes?: number | null; price: number; durationDays: number; reminderDays?: number | null; isActive?: boolean; notes?: string | null; activationInfo?: string | null; bookingInfo?: string | null; logo?: string | null; primaryColor?: string | null; secondaryColor?: string | null; provider?: Provider; createdAt?: string; }
...
export interface Payment { id: string; userId: string; subscriptionId: string; amount: number; paymentChannel?: string; paymentMethodId?: string | null; paidFromPhone?: string | null; screenshotUrl?: string | null; status: string; paymobIntentionId?: string | null; paymobTransactionId?: string | null; failureReason?: string | null; paidAt?: string | null; reviewedBy?: string | null; reviewedAt?: string | null; reviewNote?: string | null; createdAt: string; user?: { id: string; name: string; phone: string }; subscription?: Subscription; paymentMethod?: PaymentMethod | null; }
